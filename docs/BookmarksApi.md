...
result <- tryCatch(
             ...
             api_instance$get_users_id_bookmarks(var_id, max_results = var_max_results, pagination_token = var_pagination_token, tweet_fields = var_tweet_fields, expansions = var_expansions, media_fields = var_media_fields, poll_fields = var_poll_fields, user_fields = var_user_fields, place_fields = var_place_fields),
...
result <- tryCatch(
             ...
             api_instance$post_users_id_bookmarks(var_id, var_bookmark_add_request),
             ApiException = function(ex) ex
          )
# In case of error, print the error object
if (!is.null(result$ApiException)) {
...
result <- tryCatch(
             ...
             api_instance$users_id_bookmarks_delete(var_id, var_tweet_id),
             ApiException = function(ex) ex
          )
# In case of error, print the error object
if (!is.null(result$ApiException)) {
