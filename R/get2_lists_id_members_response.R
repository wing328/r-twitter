#' Create a new Get2ListsIdMembersResponse
#'
#' @description
...
#' @description Get2ListsIdMembersResponse Class
...
#' @export
Get2ListsIdMembersResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return Get2ListsIdMembersResponse in JSON format
    #' @export
    toJSON = function() {
      Get2ListsIdMembersResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2ListsIdMembersResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`errors`)) {
        Get2ListsIdMembersResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2ListsIdMembersResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      if (!is.null(self$`meta`)) {
        Get2ListsIdMembersResponseObject[["meta"]] <-
          self$`meta`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2ListsIdMembersResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2ListsIdMembersResponseObject
    },
    ...
    #' @return the instance of Get2ListsIdMembersResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2ListsIdMembersResponse
    #'
    #' @description
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2ListsIdMembersResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
Get2ListsIdMembersResponse$unlock()
...
#'
#' @export
Get2ListsIdMembersResponse$set("public", "print", function(...) {
  print(jsonlite::prettify(self$toJSONString()))
  invisible(self)
})

# Lock the class to prevent modifications to the method or field
Get2ListsIdMembersResponse$lock()
