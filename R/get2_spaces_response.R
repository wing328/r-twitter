#' Create a new Get2SpacesResponse
#'
#' @description
#' Get2SpacesResponse Class
#'
#' @docType class
#' @title Get2SpacesResponse
#' @description Get2SpacesResponse Class
...
Get2SpacesResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new Get2SpacesResponse class.
    #'
    #' @description
    #' Initialize a new Get2SpacesResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return Get2SpacesResponse in JSON format
    #' @export
    toJSON = function() {
      Get2SpacesResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2SpacesResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`errors`)) {
        Get2SpacesResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2SpacesResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2SpacesResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2SpacesResponseObject
    },
    #' Deserialize JSON string into an instance of Get2SpacesResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of Get2SpacesResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of Get2SpacesResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2SpacesResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2SpacesResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2SpacesResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# Get2SpacesResponse$unlock()
#
## Below is an example to define the print fnuction
# Get2SpacesResponse$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# Get2SpacesResponse$lock()
