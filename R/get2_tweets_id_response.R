#' Create a new Get2TweetsIdResponse
#'
#' @description
#' Get2TweetsIdResponse Class
#'
#' @docType class
#' @title Get2TweetsIdResponse
#' @description Get2TweetsIdResponse Class
...
#' @export
Get2TweetsIdResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new Get2TweetsIdResponse class.
    #'
    #' @description
    #' Initialize a new Get2TweetsIdResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return Get2TweetsIdResponse in JSON format
    #' @export
    toJSON = function() {
      Get2TweetsIdResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2TweetsIdResponseObject[["data"]] <-
          self$`data`$toJSON()
      }
      if (!is.null(self$`errors`)) {
        Get2TweetsIdResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2TweetsIdResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2TweetsIdResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2TweetsIdResponseObject
    },
    #' Deserialize JSON string into an instance of Get2TweetsIdResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of Get2TweetsIdResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of Get2TweetsIdResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2TweetsIdResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2TweetsIdResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2TweetsIdResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# Get2TweetsIdResponse$unlock()
#
## Below is an example to define the print fnuction
# Get2TweetsIdResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# Get2TweetsIdResponse$lock()
