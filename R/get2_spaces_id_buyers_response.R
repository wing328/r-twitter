#' Create a new Get2SpacesIdBuyersResponse
#'
#' @description
#' Get2SpacesIdBuyersResponse Class
#'
#' @docType class
#' @title Get2SpacesIdBuyersResponse
#' @description Get2SpacesIdBuyersResponse Class
...
#' @export
Get2SpacesIdBuyersResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new Get2SpacesIdBuyersResponse class.
    #'
    #' @description
    #' Initialize a new Get2SpacesIdBuyersResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return Get2SpacesIdBuyersResponse in JSON format
    #' @export
    toJSON = function() {
      Get2SpacesIdBuyersResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2SpacesIdBuyersResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`errors`)) {
        Get2SpacesIdBuyersResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2SpacesIdBuyersResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      if (!is.null(self$`meta`)) {
        Get2SpacesIdBuyersResponseObject[["meta"]] <-
          self$`meta`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2SpacesIdBuyersResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2SpacesIdBuyersResponseObject
    },
    #' Deserialize JSON string into an instance of Get2SpacesIdBuyersResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of Get2SpacesIdBuyersResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of Get2SpacesIdBuyersResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2SpacesIdBuyersResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2SpacesIdBuyersResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2SpacesIdBuyersResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
Get2SpacesIdBuyersResponse$unlock()
...
#'
#' @export
Get2SpacesIdBuyersResponse$set("public", "print", function(...) {
  print(jsonlite::prettify(self$toJSONString()))
  invisible(self)
})

# Lock the class to prevent modifications to the method or field
Get2SpacesIdBuyersResponse$lock()
