#' Create a new Get2UsersIdMentionsResponseMeta
#'
#' @description
#' Get2UsersIdMentionsResponseMeta Class
#'
#' @docType class
...
Get2UsersIdMentionsResponseMeta <- R6::R6Class(
  ...
  public = list(
    ...
    `previous_token` = NULL,
    `result_count` = NULL,
    `_field_list` = c("newest_id", "next_token", "oldest_id", "previous_token", "result_count"),
...
# Get2UsersIdMentionsResponseMeta$unlock()
#
## Below is an example to define the print fnuction
# Get2UsersIdMentionsResponseMeta$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# Get2UsersIdMentionsResponseMeta$lock()
