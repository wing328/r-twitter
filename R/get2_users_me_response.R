#' Create a new Get2UsersMeResponse
#'
#' @description
#' Get2UsersMeResponse Class
#'
#' @docType class
#' @title Get2UsersMeResponse
#' @description Get2UsersMeResponse Class
...
#' @export
Get2UsersMeResponse <- R6::R6Class(
  "Get2UsersMeResponse",
  public = list(
    `data` = NULL,
    `errors` = NULL,
    ...
    #' Initialize a new Get2UsersMeResponse class.
    #'
    #' @description
    #' Initialize a new Get2UsersMeResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return Get2UsersMeResponse in JSON format
    #' @export
    toJSON = function() {
      Get2UsersMeResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2UsersMeResponseObject[["data"]] <-
          self$`data`$toJSON()
      }
      if (!is.null(self$`errors`)) {
        Get2UsersMeResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2UsersMeResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2UsersMeResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2UsersMeResponseObject
    },
    #' Deserialize JSON string into an instance of Get2UsersMeResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of Get2UsersMeResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of Get2UsersMeResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2UsersMeResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2UsersMeResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2UsersMeResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
