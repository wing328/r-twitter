#' Create a new Get2ListsIdResponse
#'
#' @description
#' Get2ListsIdResponse Class
#'
#' @docType class
#' @title Get2ListsIdResponse
#' @description Get2ListsIdResponse Class
#' @format An \code{R6Class} generator object
#' @field data  \link{List} [optional]
...
#' @export
Get2ListsIdResponse <- R6::R6Class(
  "Get2ListsIdResponse",
  public = list(
    `data` = NULL,
    `errors` = NULL,
    ...
    #' Initialize a new Get2ListsIdResponse class.
    #'
    #' @description
    #' Initialize a new Get2ListsIdResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return Get2ListsIdResponse in JSON format
    #' @export
    toJSON = function() {
      Get2ListsIdResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2ListsIdResponseObject[["data"]] <-
          self$`data`$toJSON()
      }
      if (!is.null(self$`errors`)) {
        Get2ListsIdResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2ListsIdResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2ListsIdResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2ListsIdResponseObject
    },
    #' Deserialize JSON string into an instance of Get2ListsIdResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of Get2ListsIdResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of Get2ListsIdResponse
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`data`)) {
        data_object <- List$new()
...
',
    ...
    fromJSONString = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      self$`data` <- List$new()$fromJSON(jsonlite::toJSON(this_object$data, auto_unbox = TRUE, digits = NA))
      self$`errors` <- ApiClient$new()$deserializeObj(this_object$`errors`, "array[Problem]", loadNamespace("twitter"))
    ...
    #' Validate JSON input with respect to Get2ListsIdResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2ListsIdResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2ListsIdResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# Get2ListsIdResponse$unlock()
#
## Below is an example to define the print fnuction
# Get2ListsIdResponse$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# Get2ListsIdResponse$lock()
