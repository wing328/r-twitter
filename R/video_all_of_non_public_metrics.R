#' Create a new VideoAllOfNonPublicMetrics
#'
#' @description
...
VideoAllOfNonPublicMetrics <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`playback_0_count` = NULL, `playback_100_count` = NULL, `playback_25_count` = NULL, `playback_50_count` = NULL, `playback_75_count` = NULL, additional_properties = NULL, ...) {
    ...
    toJSON = function() {
      ...
      for (key in names(self$additional_properties)) {
        VideoAllOfNonPublicMetricsObject[[key]] <- self$additional_properties[[key]]
      }
