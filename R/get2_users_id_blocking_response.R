#' Create a new Get2UsersIdBlockingResponse
#'
#' @description
#' Get2UsersIdBlockingResponse Class
#'
#' @docType class
#' @title Get2UsersIdBlockingResponse
#' @description Get2UsersIdBlockingResponse Class
...
#' @export
Get2UsersIdBlockingResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new Get2UsersIdBlockingResponse class.
    #'
    #' @description
    #' Initialize a new Get2UsersIdBlockingResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return Get2UsersIdBlockingResponse in JSON format
    #' @export
    toJSON = function() {
      Get2UsersIdBlockingResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2UsersIdBlockingResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`errors`)) {
        Get2UsersIdBlockingResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2UsersIdBlockingResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      if (!is.null(self$`meta`)) {
        Get2UsersIdBlockingResponseObject[["meta"]] <-
          self$`meta`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2UsersIdBlockingResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2UsersIdBlockingResponseObject
    },
    #' Deserialize JSON string into an instance of Get2UsersIdBlockingResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of Get2UsersIdBlockingResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of Get2UsersIdBlockingResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2UsersIdBlockingResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2UsersIdBlockingResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2UsersIdBlockingResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
Get2UsersIdBlockingResponse$unlock()
...
#'
#' @export
Get2UsersIdBlockingResponse$set("public", "print", function(...) {
  print(jsonlite::prettify(self$toJSONString()))
  invisible(self)
})

# Lock the class to prevent modifications to the method or field
Get2UsersIdBlockingResponse$lock()
