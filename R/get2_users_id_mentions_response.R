#' Create a new Get2UsersIdMentionsResponse
#'
#' @description
#' Get2UsersIdMentionsResponse Class
#'
#' @docType class
...
#' @export
Get2UsersIdMentionsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new Get2UsersIdMentionsResponse class.
    #'
    #' @description
    #' Initialize a new Get2UsersIdMentionsResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return Get2UsersIdMentionsResponse in JSON format
    #' @export
    toJSON = function() {
      Get2UsersIdMentionsResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2UsersIdMentionsResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`errors`)) {
        Get2UsersIdMentionsResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2UsersIdMentionsResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      if (!is.null(self$`meta`)) {
        Get2UsersIdMentionsResponseObject[["meta"]] <-
          self$`meta`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2UsersIdMentionsResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2UsersIdMentionsResponseObject
    },
    #' Deserialize JSON string into an instance of Get2UsersIdMentionsResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of Get2UsersIdMentionsResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of Get2UsersIdMentionsResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2UsersIdMentionsResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2UsersIdMentionsResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2UsersIdMentionsResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
Get2UsersIdMentionsResponse$unlock()
...
#'
#' @export
Get2UsersIdMentionsResponse$set("public", "print", function(...) {
  print(jsonlite::prettify(self$toJSONString()))
  invisible(self)
})

# Lock the class to prevent modifications to the method or field
Get2UsersIdMentionsResponse$lock()
