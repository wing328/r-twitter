#' Create a new Get2TweetsSampleStreamResponse
#'
#' @description
#' Get2TweetsSampleStreamResponse Class
#'
#' @docType class
...
#' @export
Get2TweetsSampleStreamResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new Get2TweetsSampleStreamResponse class.
    #'
    #' @description
    #' Initialize a new Get2TweetsSampleStreamResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return Get2TweetsSampleStreamResponse in JSON format
    #' @export
    toJSON = function() {
      Get2TweetsSampleStreamResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2TweetsSampleStreamResponseObject[["data"]] <-
          self$`data`$toJSON()
      }
      if (!is.null(self$`errors`)) {
        Get2TweetsSampleStreamResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2TweetsSampleStreamResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2TweetsSampleStreamResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2TweetsSampleStreamResponseObject
    },
    #' Deserialize JSON string into an instance of Get2TweetsSampleStreamResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of Get2TweetsSampleStreamResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of Get2TweetsSampleStreamResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2TweetsSampleStreamResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2TweetsSampleStreamResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2TweetsSampleStreamResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
#Get2TweetsSampleStreamResponse$unlock()
#
## Below is an example to define the print fnuction
#Get2TweetsSampleStreamResponse$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#Get2TweetsSampleStreamResponse$lock()
