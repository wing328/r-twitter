#' Create a new Get2TweetsIdLikingUsersResponse
#'
#' @description
#' Get2TweetsIdLikingUsersResponse Class
#'
#' @docType class
#' @title Get2TweetsIdLikingUsersResponse
#' @description Get2TweetsIdLikingUsersResponse Class
...
#' @export
Get2TweetsIdLikingUsersResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new Get2TweetsIdLikingUsersResponse class.
    #'
    #' @description
    #' Initialize a new Get2TweetsIdLikingUsersResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return Get2TweetsIdLikingUsersResponse in JSON format
    #' @export
    toJSON = function() {
      Get2TweetsIdLikingUsersResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2TweetsIdLikingUsersResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`errors`)) {
        Get2TweetsIdLikingUsersResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2TweetsIdLikingUsersResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      if (!is.null(self$`meta`)) {
        Get2TweetsIdLikingUsersResponseObject[["meta"]] <-
          self$`meta`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2TweetsIdLikingUsersResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2TweetsIdLikingUsersResponseObject
    },
    #' Deserialize JSON string into an instance of Get2TweetsIdLikingUsersResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of Get2TweetsIdLikingUsersResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of Get2TweetsIdLikingUsersResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2TweetsIdLikingUsersResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2TweetsIdLikingUsersResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2TweetsIdLikingUsersResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
#Get2TweetsIdLikingUsersResponse$unlock()
#
## Below is an example to define the print fnuction
#Get2TweetsIdLikingUsersResponse$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#Get2TweetsIdLikingUsersResponse$lock()
