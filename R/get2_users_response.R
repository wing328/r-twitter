#' Create a new Get2UsersResponse
#'
#' @description
#' Get2UsersResponse Class
#'
#' @docType class
#' @title Get2UsersResponse
#' @description Get2UsersResponse Class
...
Get2UsersResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new Get2UsersResponse class.
    #'
    #' @description
    #' Initialize a new Get2UsersResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return Get2UsersResponse in JSON format
    #' @export
    toJSON = function() {
      Get2UsersResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2UsersResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`errors`)) {
        Get2UsersResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2UsersResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2UsersResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2UsersResponseObject
    },
    #' Deserialize JSON string into an instance of Get2UsersResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of Get2UsersResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of Get2UsersResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2UsersResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2UsersResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2UsersResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
#'
#' @export
Get2UsersResponse$set("public", "print", function(...) {
  print(jsonlite::prettify(self$toJSONString()))
  invisible(self)
})

# Lock the class to prevent modifications to the method or field
Get2UsersResponse$lock()
