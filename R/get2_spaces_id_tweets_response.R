#' Create a new Get2SpacesIdTweetsResponse
#'
#' @description
...
#' @description Get2SpacesIdTweetsResponse Class
...
#' @export
Get2SpacesIdTweetsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return Get2SpacesIdTweetsResponse in JSON format
    #' @export
    toJSON = function() {
      Get2SpacesIdTweetsResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2SpacesIdTweetsResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`errors`)) {
        Get2SpacesIdTweetsResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2SpacesIdTweetsResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      if (!is.null(self$`meta`)) {
        Get2SpacesIdTweetsResponseObject[["meta"]] <-
          self$`meta`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2SpacesIdTweetsResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2SpacesIdTweetsResponseObject
    },
    ...
    #' @return the instance of Get2SpacesIdTweetsResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2SpacesIdTweetsResponse
    #'
    #' @description
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2SpacesIdTweetsResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
Get2SpacesIdTweetsResponse$unlock()
...
#'
#' @export
Get2SpacesIdTweetsResponse$set("public", "print", function(...) {
  print(jsonlite::prettify(self$toJSONString()))
  invisible(self)
})

# Lock the class to prevent modifications to the method or field
Get2SpacesIdTweetsResponse$lock()
