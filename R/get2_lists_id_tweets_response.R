#' Create a new Get2ListsIdTweetsResponse
#'
#' @description
#' Get2ListsIdTweetsResponse Class
#'
#' @docType class
#' @title Get2ListsIdTweetsResponse
#' @description Get2ListsIdTweetsResponse Class
...
#' @export
Get2ListsIdTweetsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new Get2ListsIdTweetsResponse class.
    #'
    #' @description
    #' Initialize a new Get2ListsIdTweetsResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return Get2ListsIdTweetsResponse in JSON format
    #' @export
    toJSON = function() {
      Get2ListsIdTweetsResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2ListsIdTweetsResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`errors`)) {
        Get2ListsIdTweetsResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2ListsIdTweetsResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      if (!is.null(self$`meta`)) {
        Get2ListsIdTweetsResponseObject[["meta"]] <-
          self$`meta`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2ListsIdTweetsResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2ListsIdTweetsResponseObject
    },
    #' Deserialize JSON string into an instance of Get2ListsIdTweetsResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of Get2ListsIdTweetsResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of Get2ListsIdTweetsResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2ListsIdTweetsResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2ListsIdTweetsResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2ListsIdTweetsResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
Get2ListsIdTweetsResponse$unlock()
...
#'
#' @export
Get2ListsIdTweetsResponse$set("public", "print", function(...) {
  print(jsonlite::prettify(self$toJSONString()))
  invisible(self)
})

# Lock the class to prevent modifications to the method or field
Get2ListsIdTweetsResponse$lock()
