#' Create a new Get2TweetsCountsAllResponse
#'
#' @description
#' Get2TweetsCountsAllResponse Class
#'
#' @docType class
...
#' @export
Get2TweetsCountsAllResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new Get2TweetsCountsAllResponse class.
    #'
    #' @description
    #' Initialize a new Get2TweetsCountsAllResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return Get2TweetsCountsAllResponse in JSON format
    #' @export
    toJSON = function() {
      Get2TweetsCountsAllResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2TweetsCountsAllResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`errors`)) {
        Get2TweetsCountsAllResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`meta`)) {
        Get2TweetsCountsAllResponseObject[["meta"]] <-
          self$`meta`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2TweetsCountsAllResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2TweetsCountsAllResponseObject
    },
    #' Deserialize JSON string into an instance of Get2TweetsCountsAllResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of Get2TweetsCountsAllResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of Get2TweetsCountsAllResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2TweetsCountsAllResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2TweetsCountsAllResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2TweetsCountsAllResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
