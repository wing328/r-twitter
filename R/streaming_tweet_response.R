#' Create a new StreamingTweetResponse
#'
#' @description
#' StreamingTweetResponse Class
#'
#' @docType class
#' @title StreamingTweetResponse
#' @description StreamingTweetResponse Class
...
#' @export
StreamingTweetResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new StreamingTweetResponse class.
    #'
    #' @description
    #' Initialize a new StreamingTweetResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return StreamingTweetResponse in JSON format
    #' @export
    toJSON = function() {
      StreamingTweetResponseObject <- list()
      if (!is.null(self$`data`)) {
        StreamingTweetResponseObject[["data"]] <-
          self$`data`$toJSON()
      }
      if (!is.null(self$`errors`)) {
        StreamingTweetResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        StreamingTweetResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        StreamingTweetResponseObject[[key]] <- self$additional_properties[[key]]
      }

      StreamingTweetResponseObject
    },
    #' Deserialize JSON string into an instance of StreamingTweetResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of StreamingTweetResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of StreamingTweetResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to StreamingTweetResponse
    #'
    #' @description
    #' Validate JSON input with respect to StreamingTweetResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of StreamingTweetResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# StreamingTweetResponse$unlock()
#
## Below is an example to define the print fnuction
# StreamingTweetResponse$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# StreamingTweetResponse$lock()
