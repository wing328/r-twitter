#' Create a new Get2UsersIdBookmarksResponse
#'
#' @description
#' Get2UsersIdBookmarksResponse Class
#'
#' @docType class
  ...
  public = list(
    ...
    toJSON = function() {
      ...
      for (key in names(self$additional_properties)) {
        Get2UsersIdBookmarksResponseObject[[key]] <- self$additional_properties[[key]]
      }
...
#Get2UsersIdBookmarksResponse$unlock()
#
## Below is an example to define the print fnuction
#Get2UsersIdBookmarksResponse$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#Get2UsersIdBookmarksResponse$lock()
