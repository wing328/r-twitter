#' Create a new Get2ComplianceJobsResponse
#'
#' @description
#' Get2ComplianceJobsResponse Class
#'
#' @docType class
...
#' @export
Get2ComplianceJobsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return Get2ComplianceJobsResponse in JSON format
    #' @export
    toJSON = function() {
      Get2ComplianceJobsResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2ComplianceJobsResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`errors`)) {
        Get2ComplianceJobsResponseObject[["errors"]] <-
    ...
    #' @return the instance of Get2ComplianceJobsResponse
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[ComplianceJob]", loadNamespace("twitter"))
      }
...
',
    ...
    #' Validate JSON input with respect to Get2ComplianceJobsResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2ComplianceJobsResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2ComplianceJobsResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# Get2ComplianceJobsResponse$unlock()
#
## Below is an example to define the print fnuction
# Get2ComplianceJobsResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# Get2ComplianceJobsResponse$lock()
