#' Create a new Get2UsersIdListMembershipsResponse
#'
#' @description
...
#' @description Get2UsersIdListMembershipsResponse Class
...
#' @export
Get2UsersIdListMembershipsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return Get2UsersIdListMembershipsResponse in JSON format
    #' @export
    toJSON = function() {
      Get2UsersIdListMembershipsResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2UsersIdListMembershipsResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`errors`)) {
        Get2UsersIdListMembershipsResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2UsersIdListMembershipsResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      if (!is.null(self$`meta`)) {
        Get2UsersIdListMembershipsResponseObject[["meta"]] <-
          self$`meta`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2UsersIdListMembershipsResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2UsersIdListMembershipsResponseObject
    },
    ...
    #' @return the instance of Get2UsersIdListMembershipsResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2UsersIdListMembershipsResponse
    #'
    #' @description
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2UsersIdListMembershipsResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
#Get2UsersIdListMembershipsResponse$unlock()
#
## Below is an example to define the print fnuction
#Get2UsersIdListMembershipsResponse$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#Get2UsersIdListMembershipsResponse$lock()
