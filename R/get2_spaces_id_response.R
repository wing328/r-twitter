#' Create a new Get2SpacesIdResponse
#'
#' @description
#' Get2SpacesIdResponse Class
#'
#' @docType class
#' @title Get2SpacesIdResponse
#' @description Get2SpacesIdResponse Class
...
#' @export
Get2SpacesIdResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return Get2SpacesIdResponse in JSON format
    #' @export
    toJSON = function() {
      Get2SpacesIdResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2SpacesIdResponseObject[["data"]] <-
          self$`data`$toJSON()
      }
      if (!is.null(self$`errors`)) {
        Get2SpacesIdResponseObject[["errors"]] <-
    ...
    #' @return the instance of Get2SpacesIdResponse
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`data`)) {
        data_object <- Space$new()
...
',
    ...
    fromJSONString = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      self$`data` <- Space$new()$fromJSON(jsonlite::toJSON(this_object$data, auto_unbox = TRUE, digits = NA))
      self$`errors` <- ApiClient$new()$deserializeObj(this_object$`errors`, "array[Problem]", loadNamespace("twitter"))
    ...
    #' Validate JSON input with respect to Get2SpacesIdResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2SpacesIdResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2SpacesIdResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
#Get2SpacesIdResponse$unlock()
#
## Below is an example to define the print fnuction
#Get2SpacesIdResponse$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#Get2SpacesIdResponse$lock()
