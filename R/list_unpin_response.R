#' Create a new ListUnpinResponse
#'
#' @description
...
#' @description ListUnpinResponse Class
...
ListUnpinResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return ListUnpinResponse in JSON format
    #' @export
    toJSON = function() {
      ListUnpinResponseObject <- list()
      if (!is.null(self$`data`)) {
        ListUnpinResponseObject[["data"]] <-
          self$`data`$toJSON()
      }
      if (!is.null(self$`errors`)) {
        ListUnpinResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      for (key in names(self$additional_properties)) {
        ListUnpinResponseObject[[key]] <- self$additional_properties[[key]]
      }

      ListUnpinResponseObject
    },
    ...
    #' @return the instance of ListUnpinResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to ListUnpinResponse
    #'
    #' @description
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of ListUnpinResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# ListUnpinResponse$unlock()
#
## Below is an example to define the print fnuction
# ListUnpinResponse$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ListUnpinResponse$lock()
