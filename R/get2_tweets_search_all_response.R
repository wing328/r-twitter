#' Create a new Get2TweetsSearchAllResponse
#'
#' @description
#' Get2TweetsSearchAllResponse Class
#'
#' @docType class
  ...
  public = list(
    ...
    toJSON = function() {
      ...
      for (key in names(self$additional_properties)) {
        Get2TweetsSearchAllResponseObject[[key]] <- self$additional_properties[[key]]
      }
...
#Get2TweetsSearchAllResponse$unlock()
#
## Below is an example to define the print fnuction
#Get2TweetsSearchAllResponse$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#Get2TweetsSearchAllResponse$lock()
