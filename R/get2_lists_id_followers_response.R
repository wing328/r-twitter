#' Create a new Get2ListsIdFollowersResponse
#'
#' @description
#' Get2ListsIdFollowersResponse Class
#'
#' @docType class
#' @title Get2ListsIdFollowersResponse
#' @description Get2ListsIdFollowersResponse Class
...
#' @export
Get2ListsIdFollowersResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new Get2ListsIdFollowersResponse class.
    #'
    #' @description
    #' Initialize a new Get2ListsIdFollowersResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return Get2ListsIdFollowersResponse in JSON format
    #' @export
    toJSON = function() {
      Get2ListsIdFollowersResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2ListsIdFollowersResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`errors`)) {
        Get2ListsIdFollowersResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2ListsIdFollowersResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      if (!is.null(self$`meta`)) {
        Get2ListsIdFollowersResponseObject[["meta"]] <-
          self$`meta`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2ListsIdFollowersResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2ListsIdFollowersResponseObject
    },
    #' Deserialize JSON string into an instance of Get2ListsIdFollowersResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of Get2ListsIdFollowersResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of Get2ListsIdFollowersResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2ListsIdFollowersResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2ListsIdFollowersResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2ListsIdFollowersResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
Get2ListsIdFollowersResponse$unlock()
...
#'
#' @export
Get2ListsIdFollowersResponse$set("public", "print", function(...) {
  print(jsonlite::prettify(self$toJSONString()))
  invisible(self)
})

# Lock the class to prevent modifications to the method or field
Get2ListsIdFollowersResponse$lock()
