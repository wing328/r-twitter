#' Create a new Get2UsersIdMutingResponse
#'
#' @description
#' Get2UsersIdMutingResponse Class
#'
#' @docType class
#' @title Get2UsersIdMutingResponse
#' @description Get2UsersIdMutingResponse Class
...
#' @export
Get2UsersIdMutingResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new Get2UsersIdMutingResponse class.
    #'
    #' @description
    #' Initialize a new Get2UsersIdMutingResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return Get2UsersIdMutingResponse in JSON format
    #' @export
    toJSON = function() {
      Get2UsersIdMutingResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2UsersIdMutingResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`errors`)) {
        Get2UsersIdMutingResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2UsersIdMutingResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      if (!is.null(self$`meta`)) {
        Get2UsersIdMutingResponseObject[["meta"]] <-
          self$`meta`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2UsersIdMutingResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2UsersIdMutingResponseObject
    },
    #' Deserialize JSON string into an instance of Get2UsersIdMutingResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of Get2UsersIdMutingResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of Get2UsersIdMutingResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2UsersIdMutingResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2UsersIdMutingResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2UsersIdMutingResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
Get2UsersIdMutingResponse$unlock()
...
#'
#' @export
Get2UsersIdMutingResponse$set("public", "print", function(...) {
  print(jsonlite::prettify(self$toJSONString()))
  invisible(self)
})

# Lock the class to prevent modifications to the method or field
Get2UsersIdMutingResponse$lock()
