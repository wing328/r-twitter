#' Create a new Get2TweetsFirehoseStreamResponse
#'
#' @description
#' Get2TweetsFirehoseStreamResponse Class
#'
#' @docType class
#' @title Get2TweetsFirehoseStreamResponse
#' @description Get2TweetsFirehoseStreamResponse Class
...
#' @export
Get2TweetsFirehoseStreamResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new Get2TweetsFirehoseStreamResponse class.
    #'
    #' @description
    #' Initialize a new Get2TweetsFirehoseStreamResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return Get2TweetsFirehoseStreamResponse in JSON format
    #' @export
    toJSON = function() {
      Get2TweetsFirehoseStreamResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2TweetsFirehoseStreamResponseObject[["data"]] <-
          self$`data`$toJSON()
      }
      if (!is.null(self$`errors`)) {
        Get2TweetsFirehoseStreamResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2TweetsFirehoseStreamResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2TweetsFirehoseStreamResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2TweetsFirehoseStreamResponseObject
    },
    #' Deserialize JSON string into an instance of Get2TweetsFirehoseStreamResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of Get2TweetsFirehoseStreamResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of Get2TweetsFirehoseStreamResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2TweetsFirehoseStreamResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2TweetsFirehoseStreamResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2TweetsFirehoseStreamResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# Get2TweetsFirehoseStreamResponse$unlock()
#
## Below is an example to define the print fnuction
# Get2TweetsFirehoseStreamResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# Get2TweetsFirehoseStreamResponse$lock()
