#' Create a new Get2UsersIdTweetsResponse
#'
#' @description
#' Get2UsersIdTweetsResponse Class
#'
#' @docType class
#' @title Get2UsersIdTweetsResponse
#' @description Get2UsersIdTweetsResponse Class
...
#' @export
Get2UsersIdTweetsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new Get2UsersIdTweetsResponse class.
    #'
    #' @description
    #' Initialize a new Get2UsersIdTweetsResponse class.
    #'
    ...
    #' To JSON String
    #'
    #' @return Get2UsersIdTweetsResponse in JSON format
    #' @export
    toJSON = function() {
      Get2UsersIdTweetsResponseObject <- list()
      if (!is.null(self$`data`)) {
        Get2UsersIdTweetsResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toJSON())
      }
      if (!is.null(self$`errors`)) {
        Get2UsersIdTweetsResponseObject[["errors"]] <-
          lapply(self$`errors`, function(x) x$toJSON())
      }
      if (!is.null(self$`includes`)) {
        Get2UsersIdTweetsResponseObject[["includes"]] <-
          self$`includes`$toJSON()
      }
      if (!is.null(self$`meta`)) {
        Get2UsersIdTweetsResponseObject[["meta"]] <-
          self$`meta`$toJSON()
      }
      for (key in names(self$additional_properties)) {
        Get2UsersIdTweetsResponseObject[[key]] <- self$additional_properties[[key]]
      }

      Get2UsersIdTweetsResponseObject
    },
    #' Deserialize JSON string into an instance of Get2UsersIdTweetsResponse
    #'
    #' @description
    #' Deserialize JSON string into an instance of Get2UsersIdTweetsResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of Get2UsersIdTweetsResponse
    #' @export
...
',
    ...
    #' Validate JSON input with respect to Get2UsersIdTweetsResponse
    #'
    #' @description
    #' Validate JSON input with respect to Get2UsersIdTweetsResponse and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of Get2UsersIdTweetsResponse
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
Get2UsersIdTweetsResponse$unlock()
...
#'
#' @export
Get2UsersIdTweetsResponse$set("public", "print", function(...) {
  print(jsonlite::prettify(self$toJSONString()))
  invisible(self)
})

# Lock the class to prevent modifications to the method or field
Get2UsersIdTweetsResponse$lock()
