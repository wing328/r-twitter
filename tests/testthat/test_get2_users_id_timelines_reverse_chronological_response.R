...
context("Test Get2UsersIdTimelinesReverseChronologicalResponse")

model_instance <- Get2UsersIdTimelinesReverseChronologicalResponse$new()
...
test_that("meta", {
  # tests for the property `meta` (Get2UsersIdMentionsResponseMeta)
