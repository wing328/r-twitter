...
context("Test Get2TweetsIdQuoteTweetsResponse")

model_instance <- Get2TweetsIdQuoteTweetsResponse$new()
...
test_that("meta", {
  # tests for the property `meta` (Get2TweetsIdQuoteTweetsResponseMeta)
